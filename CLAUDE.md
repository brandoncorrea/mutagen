...
**YOU ARE IN: `mutagen/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mutagen/` (rig root) or other directories
...
**Your mail address:** `mutagen/polecats/obsidian`
**Your rig:** mutagen
**Your Witness:** `mutagen/witness`
...
| Ask Witness for help | `gt mail send mutagen/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mutagen/witness`) when:
...
```bash
gt mail send mutagen/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
