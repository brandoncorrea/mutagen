 ...
 * @returns {Array} mutations { line, original, mutated, name, source }
 */
 ...
 * @param {Array} options.mutators - AST visitor mutators
 * @param {Array} [options.skipNodes] - patterns to exclude
